...
def Creartabla(arreglo,database,nombre,columna):
    ...
    '''elif arreglo == "hash":
        return thash.createTable(database,nombre,columna)
    elif arreglo == "dict":
...
def CambiarNombreTabla(arreglo,database,tableOld,tableNew):
    ...
    '''elif arreglo == "hash":
        return thash.alterTable(database,tableOld,tableNew)
    elif arreglo == "dict":
...
def ExtraerTabla(arreglo,database,table):
    ...
    '''elif arreglo == "hash":
        return thash.extractTable(database,table)
    elif arreglo == "dict":
...
def ExtraerRangoTabla(arreglo,database,table,columnNumber,lower,upper):
    ...
    '''elif arreglo == "hash":
        return thash.extractRangeTable(database,table,columnNumber,lower,upper)
    elif arreglo == "dict":
...
def AgregarPK(arreglo,database,table,columns):
    ...
    '''elif arreglo == "hash":
        return thash.alterAddPKdatabase,table,columns)
    elif arreglo == "dict":
...
def EliminarPK(arreglo,database,table):
    ...
    '''elif arreglo == "hash":
        return thash.alterDropPK(database,table)
    elif arreglo == "dict":
...
def AgregarColumna(arreglo,database,table,default):
    ...
    '''elif arreglo == "hash":
        return thash.alterAddColumn(database,table,default)
    elif arreglo == "dict":
...
def EliminarColumna(arreglo,database,table,default):
    ...
    '''elif arreglo == "hash":
        return thash.alterDropColumn(database,table,default)
    elif arreglo == "dict":
...
def EliminarTabla(arreglo,database,table):
    ...
    '''elif arreglo == "hash":
        return thash.dropTable(database,table)
    elif arreglo == "dict":
...
def Tupla(arreglo,database,table,register):
    ...
    '''elif arreglo == "hash":
        return thash.insert(database,table,register)
    elif arreglo == "dict":
...
def CargandoCsvMode(arreglo,file,database,table):
    ...
    '''elif arreglo == "hash":
        return thash.loadCSV(file,database,table)
    elif arreglo == "dict":
...
def ExtraerFILA(arreglo,database,table,columns):
    ...
    '''elif arreglo == "hash":
        return thash.extractRow(database,table,columns)
    elif arreglo == "dict":
...
def actualizarupdate(arreglo,database,table,register,columns):
    ...
    '''elif arreglo == "hash":
        return thash.update(database,table,register,columns)
    elif arreglo == "dict":
...
def Deletedatos(arreglo,database,table,register):
    ...
    '''elif arreglo == "hash":
        return thash.delete(database,table,register)
    elif arreglo == "dict":
...
def TruncarTabla(arreglo,database,table):
    ...
    '''elif arreglo == "hash":
        return thash.truncate(database,table)
    elif arreglo == "dict":
